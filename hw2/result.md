  ...
  public int pow(int a, int b) {
    ...
    while (b > 0) {
      if ((b & 1) != 0) {
        ...
        result = (int) ((long) result * base); // Умножаем результат на текущее основание, если бит установлен
      }
      // Явная проверка/вычисление по модулю 2^32 через long
      base = (int) ((long) base * base); // Возводим основание в квадрат на каждой итерации
